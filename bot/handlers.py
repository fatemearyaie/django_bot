...
def build_application(token: str):
    ...
    application.add_handler(
        CallbackQueryHandler(offer_accept_cb, pattern=r"^offer_accept:\d+$")
    )
    application.add_handler(
        CallbackQueryHandler(offer_reject_cb, pattern=r"^offer_reject:\d+$")
    )
    application.add_handler(
        CallbackQueryHandler(offer_user_info_cb, pattern=r"^offer_user:\d+$")
    )
